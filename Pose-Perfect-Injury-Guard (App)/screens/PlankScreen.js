...
const plankDemoVideo = require('../assets/plank.mp4'); // Path to demo video
...
export default function LungesScreen() {
    ...
    const processVideo = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://192.168.18.22:5000/plank-analyze', formData, {
    ...
    const fetchReport = async () => {
        ...
        try {
            const response = await axios.get('http://192.168.18.22:5000/plank-get-report');
            if (response.data) {
    ...
    return (
        <ScrollView contentContainerStyle={styles.scrollViewContent}>
            <View style={styles.container}>
                ...
                {/* Demo Video */}
                <Video
                    source={plankDemoVideo} // Display the local demo video
                    style={styles.video}
                    useNativeControls
                    resizeMode="contain"
                    isLooping
                ...
                <View style={styles.instructionsContainer}>
                    ...
                    <Text style={styles.instructionsText}>
                        Don't hold your breath. Breath normally from your abdomen instead of your chest.
                    </Text>
                    <Text style={styles.instructionsText}>
                ...
                <View style={styles.instructionsContainer}>
                    ...
                    <View style={styles.mistakeItem}>
                        ...
                        <View style={styles.mistakeTextContainer}>
                            <Text style={styles.mistakeTitle}>Excessive lifting or Collapsing of the back</Text>
                            <Text style={styles.mistakeDescription}>
                                Try to keep your back straight. This will help your body appear to be in a straight line and not affect the force exerted by other parts.
                            </Text>
                        </View>
                    </View>
                </View>
                ...
                <Text style={styles.instructions}>
                    Record or upload a video of yourself performing a Plank.
                ...
                {serverResponse && serverResponse.processed_video_url && (
                  <View style={styles.videoContainer}>
