...
const bicepCurlDemoVideo = require('../assets/BicepCurl_Demo.mp4'); // Path to demo video
    ...
    return (
        <ScrollView contentContainerStyle={styles.scrollViewContent}>
            <View style={styles.container}>
                ...
                {/* Demo Video */}
                <Video
                    source={bicepCurlDemoVideo} // Display the local demo video
                    style={styles.video}
                    useNativeControls
                    resizeMode="contain"
                    isLooping
                ...
                <View style={styles.instructionsContainer}>
                    ...
                    <Text style={styles.instructionsText}>
                        Stand with your feet shoulder-width apart. Hold a dumbbell in each hand with an underhand grip palms facing forward. Let your arms hang down at your sides, elbows close to your torso, and keep your core engaged.
                    </Text>
                    <Text style={styles.instructionsText}>
                        Bend your elbows and curl the dumbbells upward towards your shoulders. Ensure that only your forearms move; keep your upper arms stationary and close to your body.
                    </Text>
                    <Text style={styles.instructionsText}>
                        Slowly lower the dumbbells back to the starting position, maintaining control throughout the movement. Avoid swinging or using momentum.
                    </Text>
                </View>
                ...
                <View style={styles.instructionsContainer}>
                    ...
                    <View style={styles.mistakeItem}>
                        ...
                        <View style={styles.mistakeTextContainer}>
                            <Text style={styles.mistakeTitle}>Loose Arm</Text>
                            <Text style={styles.mistakeDescription}>
                                This occurs when the elbows are not kept close to the body during the curl. Instead of maintaining a fixed position, the arms may sway or move away from the torso.
                                This can lead to improper muscle engagement.
                            </Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.mistakeItem}>
                        ...
                        <View style={styles.mistakeTextContainer}>
                            <Text style={styles.mistakeTitle}>Leaning Back</Text>
                            <Text style={styles.mistakeDescription}>
                                Leaning back shifts the load away from the biceps and places unnecessary strain on the lower back, increasing the risk of injury.
                ...
                <Text style={styles.instructions}>
                    Record or upload a video of yourself performing a BicepCurl.
