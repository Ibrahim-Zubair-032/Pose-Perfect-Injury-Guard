...
const lungeDemoVideo = require('../assets/LUNGE.mp4'); // Path to demo video
    ...
    return (
        <ScrollView contentContainerStyle={styles.scrollViewContent}>
            <View style={styles.container}>
                ...
                {/* Demo Video */}
                <Video
                    source={lungeDemoVideo} // Display the local demo video
                    style={styles.video}
                    useNativeControls
                    resizeMode="contain"
                    isLooping
                ...
                <View style={styles.instructionsContainer}>
                    ...
                    <Text style={styles.instructionsText}>
                        Step a big step forward or backward with your right leg and lower your body until your left thigh is parallel to the floor. Return and repeat with the other side.
                    </Text>
                </View>
                ...
                <View style={styles.instructionsContainer}>
                    ...
                    <View style={styles.mistakeItem}>
                        ...
                        <View style={styles.mistakeTextContainer}>
                            <Text style={styles.mistakeTitle}>Leaning too far forward</Text>
                            <Text style={styles.mistakeDescription}>
                                This can put excess strain on your lower back and reduce the effectiveness of the exercise.
                            </Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.mistakeItem}>
                        ...
                        <View style={styles.mistakeTextContainer}>
                            <Text style={styles.mistakeTitle}>Not Stepping Forward Far Enough</Text>
                            <Text style={styles.mistakeDescription}>
                                Stepping forward too little can result in a shallow lunge that doesn't effectively engage the muscles of your legs and glutes.
                            </Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.mistakeItem}>
                        ...
                        <View style={styles.mistakeTextContainer}>
                            <Text style={styles.mistakeTitle}>Allowing your front knee to go too far forward</Text>
                            <Text style={styles.mistakeDescription}>
                                When you are performing a Lunge, you should make sure your front knee remains properly aligned with your ankle. Otherwise, it can cause excessive pressure on the knee, potentially leading to injury or discomfort.
                            </Text>
                        </View>
                    </View>
                </View>
                ...
                <Text style={styles.instructions}>
                    Record or upload a video of yourself performing a Lunge.
